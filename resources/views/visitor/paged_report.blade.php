...
@section('content')
    <div class="container mx-auto mt-8 text-white">
        ...
        <table class="min-w-full divide-y divide-gray-600">
            <thead>
                <tr>
                    <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase">Visitor Name</th>
                    <th class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase">Visiting Officer</th>
